...
public class ResourceRegistry implements Disposable {
    ...
    public ResourceRegistry() {
        this.defaultPack = new ResourcePack("./resource-packs/vanilla-pack.zip");
    ...
    public ResourceAtlas registerAtlas(String ID, String path, int width, int height) {
        return atlas.register(new ResourceAtlas(defaultPack, ID, path, width, height));
    }

    public ResourceMusic registerMusic(String ID, String path) {
        return music.register(new ResourceMusic(defaultPack, ID, path));
    }

    public ResourceShader registerShader(String ID, String path) {
        return shader.register(new ResourceShader(defaultPack, ID, path));
    }

    public ResourceSkybox registerSkybox(String ID, String path) {
        return skybox.register(new ResourceSkybox(defaultPack, ID, path));
    }

    public ResourceTexture registerTexture(String ID, String path) {
        return texture.register(new ResourceTexture(defaultPack, ID, path));
    }
